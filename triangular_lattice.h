#ifndef TRIANGULAR_LATTICE_CLASS_H
#define TRIANGULAR_LATTICE_CLASS_H

#include "lattice.h"

class Triangular_lattice : public Lattice {
	public:
		Triangular_lattice(const size_t& h, const size_t& w, const double& J_): 
				Lattice(h, w, J_) {coordination = 6;}
...
#endif //TRIANGULAR_LATTICE_CLASS_H
